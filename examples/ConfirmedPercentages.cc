...
int main (int argc, char *argv[])
{
  ...
  *************/
  ...
  std::cout << nDevices << " " << totalPktsSent << " " << float(received)/float(nDevices) << " " << float(interfered)/float(nDevices) << " " << float(noMoreReceivers)/float(nDevices)
