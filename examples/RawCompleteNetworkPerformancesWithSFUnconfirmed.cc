...
NS_LOG_COMPONENT_DEFINE ("RawCompleteNetworkPerformancesWithSFUnconfirmed");
...
int main (int argc, char *argv[])
{
  ...
  // Set up logging
  LogComponentEnable ("RawCompleteNetworkPerformancesWithSFUnconfirmed", LOG_LEVEL_ALL);
  ...
  *************/
  ...
  // Dont't perform when dealing with only Unconfirmed traffic
